    ...
    return(
        ...
        <div>
            { 
                ...
                <ErrorDialog value={onClaimSuccess} title={'Claim Success!'} context={`Insurance Company transfer ${amount*price} WEI to your account。`} onClose={()=>{ setOnClaimSuccess(false)}}></ErrorDialog>
                <ErrorDialog value={onCertificateError} title={'Not Eligible'} context={'No Relevant Certificate'} onClose={()=>{setOnCertificateError(false)}}></ErrorDialog>
